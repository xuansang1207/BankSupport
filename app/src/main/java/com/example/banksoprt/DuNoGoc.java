...
public class DuNoGoc extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_du_no_goc);
        ...
        btnTinh.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (edtLai.getText().toString().isEmpty() || edtLai.getText().toString().isEmpty() || edtThoiGian.getText().toString().isEmpty()) {
                    ...
                    tongLai.setText(decimalFormat.format(tienVay/thoiGianVay+tienVay*laiThang));
